...
from ..aws_secretsmanager import (
    ISecret as _ISecret_6e020e6a, Secret as _Secret_50778576
)
from ..aws_sns import (
...
class SelfManagedKafkaEventSourceProps(KafkaEventSourceProps):
    def __init__(
        ...
        *,
        ...
        root_ca_certificate: typing.Optional[_Secret_50778576] = None,
    ...
    @builtins.property
    def root_ca_certificate(self) -> typing.Optional[_Secret_50778576]:
        ...
        return typing.cast(typing.Optional[_Secret_50778576], result)
