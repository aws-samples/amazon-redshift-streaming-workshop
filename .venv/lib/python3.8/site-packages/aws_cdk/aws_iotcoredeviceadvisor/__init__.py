...
class CfnSuiteDefinition(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        suite_definition_configuration: typing.Union[typing.Union["CfnSuiteDefinition.SuiteDefinitionConfigurationProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b],
    ...
    def suite_definition_configuration(
        self,
    ) -> typing.Union["CfnSuiteDefinition.SuiteDefinitionConfigurationProperty", _IResolvable_da3f097b]:
        ...
        *Type:* String
        ...
        '''
        return typing.cast(typing.Union["CfnSuiteDefinition.SuiteDefinitionConfigurationProperty", _IResolvable_da3f097b], jsii.get(self, "suiteDefinitionConfiguration"))

    @suite_definition_configuration.setter
    def suite_definition_configuration(
        self,
        value: typing.Union["CfnSuiteDefinition.SuiteDefinitionConfigurationProperty", _IResolvable_da3f097b],
    ) -> None:
        if __debug__:
...
class CfnSuiteDefinitionProps:
    ...
    def suite_definition_configuration(
        ...
        *Type:* String
        ...
        return typing.cast(typing.Union[CfnSuiteDefinition.SuiteDefinitionConfigurationProperty, _IResolvable_da3f097b], result)
