...
class CfnConnector(
    ...
    def __init__(
        ...
        *,
        ...
        :param connector_provisioning_config: ``AWS::AppFlow::Connector.ConnectorProvisioningConfig``.
        :param connector_provisioning_type: ``AWS::AppFlow::Connector.ConnectorProvisioningType``.
        :param connector_label: ``AWS::AppFlow::Connector.ConnectorLabel``.
        :param description: ``AWS::AppFlow::Connector.Description``.
        '''
        if __debug__:
    ...
    class ConnectorProvisioningConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param lambda_: ``CfnConnector.ConnectorProvisioningConfigProperty.Lambda``.
    ...
    class LambdaConnectorProvisioningConfigProperty:
        def __init__(self, *, lambda_arn: builtins.str) -> None:
            '''
            :param lambda_arn: ``CfnConnector.LambdaConnectorProvisioningConfigProperty.LambdaArn``.
    ...
    class OAuthCredentialsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param access_token: ``CfnConnectorProfile.OAuthCredentialsProperty.AccessToken``.
            :param client_id: ``CfnConnectorProfile.OAuthCredentialsProperty.ClientId``.
            :param client_secret: ``CfnConnectorProfile.OAuthCredentialsProperty.ClientSecret``.
            :param connector_o_auth_request: ``CfnConnectorProfile.OAuthCredentialsProperty.ConnectorOAuthRequest``.
            :param refresh_token: ``CfnConnectorProfile.OAuthCredentialsProperty.RefreshToken``.
