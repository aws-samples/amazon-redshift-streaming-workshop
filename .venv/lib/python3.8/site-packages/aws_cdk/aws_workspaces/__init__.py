...
class CfnWorkspace(
    ...
    def __init__(
        ...
        *,
        ...
        workspace_properties: typing.Optional[typing.Union[typing.Union["CfnWorkspace.WorkspacePropertiesProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
    ) -> None:
