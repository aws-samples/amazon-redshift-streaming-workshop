...
class CfnNotificationRule(
    ...
    def __init__(
        ...
        *,
        ...
        targets: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnNotificationRule.TargetProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]]],
