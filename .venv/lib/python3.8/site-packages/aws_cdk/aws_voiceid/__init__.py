...
class CfnDomain(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        server_side_encryption_configuration: typing.Union[typing.Union["CfnDomain.ServerSideEncryptionConfigurationProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b],
